# v2.0 Tabular Classification Review
...
- Best checkpoint path: artifacts\v2.0-train\checkpoints\v2.0_train_best.pt
...
- v2.0.1: fix evaluation pipeline
- v3.0: try a different dataset
