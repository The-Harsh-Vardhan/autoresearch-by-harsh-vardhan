...
from chakra.core.utils import load_config, prepare_workspace_temp, repo_path
...
def validate_versioned_notebook(
    ...
    required_notebook_commands = (
        f"python -m chakra validate-version --version {version}",
        "python -m chakra.hndsr_vr.train_runner --config",
        "python -m chakra.hndsr_vr.evaluate_runner --config",
    )
    ...
    try:
        ...
        from chakra.core import tracker as _tracker  # noqa: F401
        from chakra.core import utils as _utils  # noqa: F401
