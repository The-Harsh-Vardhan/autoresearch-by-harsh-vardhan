...
class LifecycleHooks:
    ...
    def render_notebook(self, version: str, parent: str | None, paths: VersionPaths) -> str:
        ...
        control_lines = [
            "subprocess.run(\n",
            f'    [sys.executable, "-m", "chakra.domains.nlp_lm.train_runner",\n',
        ...
        eval_lines = [
            "subprocess.run(\n",
            f'    [sys.executable, "-m", "chakra.domains.nlp_lm.evaluate_runner",\n',
            f'     "--config", "configs/nlp_lm/{version}_train.yaml",\n',
